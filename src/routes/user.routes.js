...
router.post("/forgot-password", validateForgotPassword, userController.forgotPassword.bind(userController));
router.post("/reset-password", validateResetPassword, userController.resetPassword.bind(userController));
